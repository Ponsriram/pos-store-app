...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,storeId,categoryId,name,description,price,taxPercent,isActive,sortOrder,createdAt);

@override
String toString() {
  return 'Product(id: $id, storeId: $storeId, categoryId: $categoryId, name: $name, description: $description, price: $price, taxPercent: $taxPercent, isActive: $isActive, sortOrder: $sortOrder, createdAt: $createdAt)';
}
